...
const handlePostSubmit = async (postData) => {
  ...
  try {
    ...
    <div className="col-12 col-md-9">
      ...
      <div className="mb-3">
    Организуем локальные сообщества семей на СО и семейные микро-классы вскладчину, встречаемся для общения и социализации детей, планируем совместные выезды для изучения окружающего мира, обмениваемся идеями, ссылками и рекомендациями, помогаем друг другу присмотреть за детьми по-очереди, оптимизируем логистику развозки по кружкам и обсуждаем любые вопросы про семейное образование.
    <span> </span>
