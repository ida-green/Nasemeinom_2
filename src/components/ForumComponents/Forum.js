...
const handlePostSubmit = async (postData) => {
  ...
  try {
    ...
    <div className="col-12 col-md-9">
      ...
      <div className="mb-3">
    Что есть на форуме и о чем можно писать:
    локальные сообщества семей на СО, семейные микро-классы вскладчину, встречи для общения и социализации детей, совместные выезды для изучения окружающего мира, обмен идеями, ссылками и рекомендациями, присмотр за детьми или развозка детей по-очереди, совместно нанять педагога и разделить расходы, соло-мамы помогают друг другу, семьи с детьми на СО в эмиграции.
    <div>Можно публиковать ссылки на некоммерческие образовательные проекты. Если у вас бизнес-проект (школа, курсы, группы, лагерь, экскурсии или т. п.), и вы хотите разместить информацию о нем, напишите нам в Telegram или на email: nasemeinom@mail.ru. Реклама требует маркировки. Пожалуйста, не размещайте ссылки на чужие коммерческие проекты. </div>
